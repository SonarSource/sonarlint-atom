...
const lsDownloadUrl = 'https://sonarsource.bintray.com/Distribution/sonarlint-language-server/sonarlint-language-server-3.9.0.1892.jar';
const lsFilename = 'sonarlint-ls.jar';
const lsSize = 13105876;

const sonarjs = { name: 'SonarJS', filename: 'sonarjs.jar', size: 3468050, downloadUrl: 'https://sonarsource.bintray.com/Distribution/sonar-javascript-plugin/sonar-javascript-plugin-4.2.1.6529.jar'};
const sonarphp = { name: 'SonarPHP', filename: 'sonarphp.jar', size: 2659371, downloadUrl: 'https://sonarsource.bintray.com/Distribution/sonar-php-plugin/sonar-php-plugin-2.14.0.3569.jar'};
const sonarpython = { name: 'SonarPython', filename: 'sonarpython.jar', size: 1562193, downloadUrl: 'https://sonarsource.bintray.com/Distribution/sonar-python-plugin/sonar-python-plugin-1.10.0.2131.jar'};
const sonarts = { name: 'SonarTS', filename: 'sonarts.jar', size: 2191763, downloadUrl: 'https://sonarsource.bintray.com/Distribution/sonar-typescript-plugin/sonar-typescript-plugin-1.8.0.3332.jar'};
