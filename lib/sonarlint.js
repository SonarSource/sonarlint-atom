...
const lsDownloadUrl = 'https://repox.sonarsource.com/sonarsource-public-dev/org/sonarsource/sonarlint/core/sonarlint-language-server/3.2.0.1441/sonarlint-language-server-3.2.0.1441.jar';
...
class SonarLintLanguageClient extends AutoLanguageClient {
  ...
  getGrammarScopes () { return ['source.js', 'source.js.jsx', 'text.html.vue', 'source.python', 'text.html.php']; }
  ...
  startServerProcess (projectPath) {
    ...
    .then(() => {
      ...
      const extraArgs = this.parseArgs(atom.config.get('sonarlint.extraVmArgs'));
      args.push(...extraArgs);
