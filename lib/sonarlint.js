...
const lsDownloadUrl = 'https://binaries.sonarsource.com/Distribution/sonarlint-language-server/sonarlint-language-server-3.9.0.1892.jar';
const lsFilename = 'sonarlint-ls.jar';
const lsSize = 13105876;
